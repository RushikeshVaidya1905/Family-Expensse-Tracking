...
int create_initial_db(struct User user_database[],struct Family family_database[] , struct Expense expense_database[])
{
    user_database[0].user_id = 112;
    user_database[1].user_id = 142;
    user_database[2].user_id = 345;
    user_database[3].user_id = 62;
    user_database[4].user_id = 5;
    user_database[5].user_id = 11;
    user_database[6].user_id = 79;
    user_database[7].user_id = 83;
    user_database[8].user_id = 91;
    user_database[9].user_id = 100;
    user_database[10].user_id = 117;
    user_database[11].user_id = 123;
    user_database[12].user_id = 138;
    user_database[13].user_id = 143;
    user_database[14].user_id = 154;
    user_database[15].user_id = 169;
    user_database[16].user_id = 174;
    user_database[17].user_id = 181;
    user_database[18].user_id = 122;
    user_database[19].user_id = 20;
    user_database[20].user_id = 219;
    user_database[21].user_id = 202;
    user_database[22].user_id = 235;
    user_database[23].user_id = 24;
    user_database[24].user_id = 50;
    strcpy(user_database[0].user_name , "ram");
    strcpy(user_database[1].user_name , "sham");
    strcpy(user_database[2].user_name , "dev");
    strcpy(user_database[3].user_name , "rushi");
    strcpy(user_database[4].user_name , "nishaad");
    strcpy(user_database[5].user_name , "shraddheya");
    strcpy(user_database[6].user_name , "atharv");
    strcpy(user_database[7].user_name , "ayush");
    strcpy(user_database[8].user_name , "yatharth");
    strcpy(user_database[9].user_name , "piyush");
    strcpy(user_database[10].user_name , "prajwal");
    strcpy(user_database[11].user_name , "tanish");
    strcpy(user_database[12].user_name , "mihir");
    strcpy(user_database[13].user_name , "arjun");
    strcpy(user_database[14].user_name , "dhanu");
    strcpy(user_database[15].user_name , "anand");
    strcpy(user_database[16].user_name , "sidhant");
    strcpy(user_database[17].user_name , "vinit");
    strcpy(user_database[18].user_name , "pushpal");
    strcpy(user_database[19].user_name , "jayesh");
    strcpy(user_database[20].user_name , "himanshu");
    strcpy(user_database[21].user_name , "luv");
    strcpy(user_database[22].user_name , "prasanna");
    strcpy(user_database[23].user_name , "abhi");
    strcpy(user_database[24].user_name , "shree");
    user_database[0].user_income = 1000;
    user_database[1].user_income = 5000;
    user_database[2].user_income = 2000;
    user_database[3].user_income = 500;
    user_database[4].user_income = 100;
    user_database[5].user_income = 6000;
    user_database[6].user_income = 1200;
    user_database[7].user_income = 1600;
    user_database[8].user_income = 1100;
    user_database[9].user_income = 3500;
    user_database[10].user_income = 9900;
    user_database[11].user_income = 1440;
    user_database[12].user_income = 1070;
    user_database[13].user_income = 1890;
    user_database[14].user_income = 1122;
    user_database[15].user_income = 6435;
    user_database[16].user_income = 1234;
    user_database[17].user_income = 8765;
    user_database[18].user_income = 9765;
    user_database[19].user_income = 8765;
    user_database[20].user_income = 7654;
    user_database[21].user_income = 2345;
    user_database[22].user_income = 3455;
    user_database[23].user_income = 8764;
    user_database[24].user_income = 2933;
    family_database[0].family_id = 12;
    family_database[1].family_id = 24;
    family_database[2].family_id = 36;
    family_database[3].family_id = 48;
    family_database[4].family_id = 60;
    family_database[5].family_id = 72;
    family_database[6].family_id = 84;
    family_database[7].family_id = 96;
    family_database[8].family_id = 11;
    family_database[9].family_id = 23;
    family_database[0].Users_id_family[0] = 112;
    family_database[0].Users_id_family[1] = 142;
    family_database[0].Users_id_family[2] = 345;
    family_database[0].Users_id_family[3] = 62;
    family_database[1].Users_id_family[0] = 5;
    family_database[2].Users_id_family[0] = 11;
    family_database[2].Users_id_family[1] = 79;
    family_database[2].Users_id_family[2] = 83;
    family_database[3].Users_id_family[0] = 91;
    family_database[4].Users_id_family[0] = 100;
    family_database[4].Users_id_family[1] = 117;
    family_database[4].Users_id_family[2] = 123;
    family_database[4].Users_id_family[3] = 138;
    family_database[5].Users_id_family[0] = 143;
    family_database[5].Users_id_family[1] = 154;
    family_database[5].Users_id_family[2] = 169;
    family_database[6].Users_id_family[0] = 174;
    family_database[6].Users_id_family[1] = 181;
    family_database[6].Users_id_family[2] = 122;
    family_database[6].Users_id_family[3] = 20;
    family_database[7].Users_id_family[0] = 219;
    family_database[7].Users_id_family[1] = 202;
    family_database[7].Users_id_family[2] = 235;
    family_database[8].Users_id_family[0] = 24;
    family_database[9].Users_id_family[0] = 50;
    family_database[0].family_income = 8500;
    family_database[1].family_income = 100;
    family_database[2].family_income = 8800;
    family_database[3].family_income = 1100;
    family_database[4].family_income = 15910;
    family_database[5].family_income = 9447;
    family_database[6].family_income = 28529;
    family_database[7].family_income = 13454;
    family_database[8].family_income = 8764;
    family_database[9].family_income = 2933;
    strcpy(family_database[0].family_name , "sweet");
    strcpy(family_database[1].family_name , "family");
    strcpy(family_database[2].family_name , "home");
    strcpy(family_database[3].family_name , "house");
    strcpy(family_database[4].family_name , "a");
    strcpy(family_database[5].family_name , "b");
    strcpy(family_database[6].family_name , "c");
    strcpy(family_database[7].family_name , "d");
    strcpy(family_database[8].family_name , "e");
    strcpy(family_database[9].family_name , "f");    
    expense_database[0].expense_id = 12;
    expense_database[0].user_id = 112;
    expense_database[0].expense_date.day = 3;
    expense_database[0].expense_date.month = 6;
    strcpy(expense_database[0].expense_category ,"Utility");
    expense_database[0].expense_amount = 100;
    expense_database[1].expense_id = 17;
    expense_database[1].user_id = 142;
    expense_database[1].expense_date.day = 4;
    expense_database[1].expense_date.month = 5;
    strcpy(expense_database[1].expense_category ,"Rent");
    expense_database[1].expense_amount = 245;
    expense_database[2].expense_id = 27;
    expense_database[2].user_id = 112;
    expense_database[2].expense_date.day = 3;
    expense_database[2].expense_date.month = 6;
    strcpy(expense_database[2].expense_category ,"Grocery");
    expense_database[2].expense_amount = 500;
    expense_database[3].expense_id = 25;
    expense_database[3].user_id = 142;
    expense_database[3].expense_date.day = 7;
    expense_database[3].expense_date.month = 11;
    strcpy(expense_database[3].expense_category ,"Stationary");
    expense_database[3].expense_amount = 50;
    expense_database[4].expense_id = 29;
    expense_database[4].user_id = 79;
    expense_database[4].expense_date.day = 1;
    expense_database[4].expense_date.month = 1;
    strcpy(expense_database[4].expense_category ,"Rent");
    expense_database[4].expense_amount = 1000;
    expense_database[5].expense_id = 152;
    expense_database[5].user_id = 143;
    expense_database[5].expense_date.day = 9;
    expense_database[5].expense_date.month = 11;
    strcpy(expense_database[5].expense_category ,"Leisure");
    expense_database[5].expense_amount = 100;
}
...
int main()
{
    ...
    create_initial_db(user_database,family_database,expense_database);
